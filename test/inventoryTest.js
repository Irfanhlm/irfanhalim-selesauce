...
async function inventoryTest() {
    describe('INVENTORY Page Test Case', function () {
        const listBrowser = [
            {
                name: "chrome",
        ...
        for (const browser of listBrowser) {
            describe(`Testing with ${browser.displayName}`, function () {
                ...
                it('Add Item to Cart', async function () {
                    ...
                    let removeButtonText = await inventoryPage.isRemoveButtonText();

                    assert.strictEqual(
                        removeButtonText.includes('Remove'),
                        true,
                ...
                it('Validation Item Success Added to Cart', async function () {
                    let removeButtonEnable = await inventoryPage.isRemoveButtonEnabled();
                    let shoppingCart = await inventoryPage.isCartButtonDisplayed();
